	...
	wp_localize_script(
		...
		array(
			...
			'i18n'    => array(
				...
				'noDocuments'   => __( 'No documents generated yet for this case.', 'prose-app' ),
				'yourCases'     => __( 'Your cases', 'prose-app' ),
				'casesLead'     => __( 'Each conversation is a case record. Expand a row to see progress, lifecycle, courts, and documents. The most recent case opens by default.', 'prose-app' ),
				'caseProgress'  => __( 'Case Progress', 'prose-app' ),
				'caseLifecycle' => __( 'Case Lifecycle', 'prose-app' ),
				'courtsInvolved' => __( 'Courts Involved', 'prose-app' ),
				'generatedDocuments' => __( 'Generated Documents', 'prose-app' ),
				'confidence'    => __( 'Confidence', 'prose-app' ),
				'suggestedFollowUp' => __( 'Suggested follow-up', 'prose-app' ),
